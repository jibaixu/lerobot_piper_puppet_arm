...
lerobot-record \
  ...
  --robot.cameras='{wristcam: {"type": "intelrealsense", "serial_number_or_name": "317422074519", "width": 1920, "height": 1080, "fps": 30}}' \
  --teleop.type=piper_leader \
  --teleop.id=piper_leader \
  --display_data=true \
  --dataset.repo_id=test/piper-test1 \
  --dataset.num_episodes=2 \
...
lerobot-record \
  --robot.type=piper_follower \
  --robot.id=piper_follower \
  --robot.cameras='{wristcam: {"type": "intelrealsense", "serial_number_or_name": "317422074519", "width": 640, "height": 360, "fps": 30}}' \
  --teleop.type=piper_leader \
  --teleop.id=piper_leader \
  --display_data=true \
  --dataset.repo_id=test/piper-test1 \
